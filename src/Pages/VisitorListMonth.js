...
import TableToPDF from "../components/pdf/TableToPDF";

const VisitorListMonth = () => {
    // Table Structure
                ...
                <div className='m-10'>
                    <div className="relative overflow-x-auto shadow-md bg-white">
                       <div className='flex justify-between items-center px-4 py-2'>
                            ...
                            <button className='font-bold text-purple-500 bg-purple-200 p-1 hover:bg-purple-100' onClick={handleOpenPdf}>Download</button>
                       </div>
                        {showPDFViewer ? <TableToPDF tableData={visitor}/> :
                            <div>

                                <div className="bg-white overflow-auto shadow px-4">
                                    <table className="w-full p-10" id="my-table">
...
export default VisitorListMonth;
